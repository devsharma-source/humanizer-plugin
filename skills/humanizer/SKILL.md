...
**Fix:** Use simple "is/are/has" constructions instead.
...
**Problem:** AI outputs lists where items start with bolded headers followed by colons. Convert to prose where possible.
...
**Problem:** Over-qualifying statements with "could potentially possibly be argued that."
...
7. Ask: "Now make it not obviously AI generated." - revise accordingly
